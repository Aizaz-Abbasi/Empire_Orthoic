...
Messages sent to the `stdout` and `stderr` (such as `NSLog`, `std::cout`, `std::cerr`, `printf`) will be sent to the
given IPv4 address on the specified port.
...
- Parameter ipv4Address: The IPv4 address of the remote console.
- Parameter port: The port of the remote console.
