...
//"sdk-tX43a4NoofXJoKDomJ-femJLMMzi5hMAEX2bHrN3cI0" 1
...
//    if !UserDefaults.standard.bool(forKey: "skipHelpDialog") {
//      showHelpDialog()
//    }
...
extension ViewController {
  ...
  func makeOptionsSet() -> OptionsSet {
    ...
    let groupTracker = OptionsGroup(id: .trackerGroup)
      .addEnum(id: .trackerType, map: ["Color + Depth", "Depth Only"], val: 1, onChange: { [weak self] (_: OptionId, _: [String], val: Int) in
