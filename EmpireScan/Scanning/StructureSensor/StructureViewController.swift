...
@objcMembers
class StructureViewController: UIViewController, STBackgroundTaskDelegate, MeshViewDelegate, AVCaptureVideoDataOutputSampleBufferDelegate, UIGestureRecognizerDelegate {
...
extension StructureViewController: SettingsPopupViewDelegate {
