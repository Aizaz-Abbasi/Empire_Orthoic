...
struct EditorImagePicker: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: UIViewControllerRepresentableContext<EditorImagePicker>) -> UIImagePickerController {
    ...
    func updateUIViewController(_ uiViewController: UIImagePickerController, context: UIViewControllerRepresentableContext<EditorImagePicker>) { }
...
struct ImagePicker_Previews: PreviewProvider {
    static var previews: some View {
        EditorImagePicker(didFinishSelection: { _ in })
    }
}
